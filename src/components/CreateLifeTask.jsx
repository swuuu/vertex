...
function CreateLifeTask(props) {
    ...
    const [taskInfo, setTaskInfo] = useState({lifeTaskTitle: "", lifeTaskDetails:"" ,onRepeat: false});
    ...
    return (
        <form className="create-life-task">
            <h4>LIFE</h4>
            <div className="row">
                <label className="text-input-label col-lg-2 col-md-2 col-sm-2" >Task Title</label>
            ...
            <div className="row">
                <label className="text-input-label col-lg-2 col-md-2 col-sm-2" >Details</label>
                <div className="col-lg-10 col-md-10 col-sm-10">
